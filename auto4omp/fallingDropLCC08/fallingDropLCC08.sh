...
do
    ...
    echo "========================================================"
    OMP_SCHEDULE=auto,$AUTOPAS_CHUNK $AUTOPAS_MD_FLEXIBLE_COMMAND --output-suffix $AUTOPAS_YAML_INPUT-auto$AUTOPAS_CHUNK --output-suffix $AUTOPAS_YAML_INPUT-auto$AUTOPAS_CHUNK
done
